...
categories =  ['airplanes', 'Faces', 'Leopards','Motorbikes' ]
...
print('Starting Dictionary clustering...It will take several time...')

dictionary = bowTrainer.cluster()
np.save('./101dict.npy', dictionary)    # .npy extension is added if not given
