       ...
       # cv2.putText(image, "Locked", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2)
        ...
        for (x,y,w,h) in faces:
          ...
          #  if confidence > accuracy:
           #     cv2.putText(image, "Match", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,0), 2,  cv2.LINE_AA)
           # else:
           #     cv2.putText(image, "Not Match", (250, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (0,0,255), 2, cv2.LINE_AA)
            display_string =  '{}({}%)'.format(uname, confidence)
            print(display_string)
            txt, base = cv2.getTextSize(display_string, cv2.FONT_HERSHEY_PLAIN, 1, 3)
            print(txt, base)
            cv2.rectangle(image, (x,y-base-txt[1]), (x+txt[0], y+txt[1]), (0,255,255), -1)
            #cv2.putText(image, display_string, (x, y), cv2.FONT_HERSHEY_PLAIN, 1, (255,120,150), 2,cv2.LINE_AA)
            cv2.putText(image, display_string, (x, y), cv2.FONT_HERSHEY_PLAIN, 1, (200,200,200), 2,cv2.LINE_AA)
